...
type Props = {
  theme: { title: string; authorId: string; description: string; id: string };
};

const UpdateThemeForm = ({ theme }: Props) => {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} type='text' minLength={3} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='mt-4'>
              ...
              <FormControl>
                <Textarea
                  placeholder='Entrez une courte description de votre thème'
